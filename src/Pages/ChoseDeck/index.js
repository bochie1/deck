        ...
        <div className="col-lg-10 col-md-12 mx-auto">
          <div className="container-fluid">
            ...
            <div className="row mt-5">
              <div className="col-lg-3 col-md-4 col-sm-6 col-6 mb-4" onClick={() => history.push("/home/test/true-or-false")}>
                <Deck color={"#AB6FDC"} label="German - Irregular Verbs" />
              </div>
              <div className="col-lg-3 col-md-4 col-sm-6 col-6 mb-4" onClick={() => history.push("/home/test/multiple")}>
              ...
              <div className="col-lg-3 col-md-4 col-sm-6 col-6 mb-4">
                <Deck color={"#539D85"} label="Probabilistic Graphical Models" />
              </div>
              <div className="col-lg-3 col-md-4 col-sm-6 col-6 mb-4">
